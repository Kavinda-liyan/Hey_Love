    ...
    <PageWrapper Bg_Color={"bg-teal-700"}>
      <div className="relative h-full w-full flex flex-col">
        <div className="absolute top-0 left-0">
          <Button_2 icon_Lable={faHome} Click_Action={handleHome} />
        </div>
        <div className="ml-auto mr-auto mt-auto mb-auto text-center">
          <div>
            <h1 className="text-4xl font-semibold text-teal-100" ref={txtRef1}>
              Hi,
            </h1>
            <h2 className="text-2xl font-semibold text-teal-200" ref={txtRef2}>
              Devi..
            </h2>
            <h3
              className="text-lg font-semibold text-teal-300 w-50"
              ref={txtRef3}
            >
